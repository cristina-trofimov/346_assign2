...
public class Server extends Thread {
    ...
    {   
        ...
        serverStartTime = System.currentTimeMillis();		/* Get the start time of the server thread */

        processTransactions(trans);						/* Process the transactions */

        serverEndTime = System.currentTimeMillis();		/* Get the end time of the server thread */
